...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <h6 class="ps-2">Customer Register</h6>
...
@push('scripts')
    @php
        $reportCfg = [
            ...
            'searchUrl' => route('customer-register.search'),
            'columns' => [
                ['key' => 'Party_Code', 'label' => 'Code'],
                ['key' => 'Party_Name', 'label' => 'Customer'],
                ['key' => 'Opening_Amt', 'label' => 'Opening', 'type' => 'amount'],
                ['key' => 'Sale_Amt', 'label' => 'Sale', 'type' => 'amount'],
                ['key' => 'Receipt_Amt', 'label' => 'Receipt', 'type' => 'amount'],
                ['key' => 'Closing_Amt', 'label' => 'Closing Balance', 'type' => 'amount'],
            ],
            'totals' => ['Opening_Amt', 'Sale_Amt', 'Receipt_Amt', 'Closing_Amt'],
            'ledger_columns' => [
