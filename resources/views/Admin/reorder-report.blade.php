...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
            <h6 class="ps-2">Reorder Level Report</h6>
...
@push('scripts')
    @php
        $reportCfg = [
            ...
            'searchUrl' => route('reorder-report.search'),
            'columns' => [
                ['key' => 'Prod_Code', 'label' => 'Item Code'],
                ['key' => 'Prod_ShortNm', 'label' => 'Item Name'],
                ['key' => 'Unit_Name', 'label' => 'Unit'],
                ['key' => 'On_Hand', 'label' => 'On Hand', 'type' => 'qty'],
                ['key' => 'ReOrder_Qty', 'label' => 'Reorder Qty', 'type' => 'qty'],
                ['key' => 'Short_Qty', 'label' => 'Short Qty', 'type' => 'qty'],
                ['key' => 'Alert_Status', 'label' => 'Status'],
            ],
            'totals' => ['On_Hand', 'Short_Qty'],
        ];
    @endphp
