	<div class="header">						
        ...
        @if(isset($pageTitle))
            <li class="breadcrumb-item d-flex align-items-center"><a href="{{route('user-dashboard')}}"><i class="isax isax-home-2 me-1"></i>Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ $pageTitle }}</li>
        @else
            <li class="breadcrumb-item active d-flex align-items-center"><span class="d-none d-lg-inline">
        ...
        @endif
						...
						<div class="d-flex align-items-center">	
							...
							<div class="input-icon-end position-relative me-2" id="menu-search-wrapper">
								<input type="text" id="menu-search" class="form-control" placeholder="Menu Search" autocomplete="off">
								{{-- <span class="input-icon-addon">
									<i class="isax isax-search-normal"></i>
								</span>  --}}
								 <div id="search-results" class="dropdown-menu show" style="display: none; width: 100%; max-height: 400px; overflow-y: auto;"></div>
							</div>
							<!-- /Search -->
								...
								<div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
									...
									<div class="notification-body position-relative z-2 rounded-0" data-simplebar>
										...
										<div class="dropdown-item notification-item py-2 text-wrap border-bottom" id="notification-1">
											<div class="d-flex">
												<div class="me-2 position-relative flex-shrink-0">
													<img src="{{asset('template/assets/img/profiles/avatar-05.jpg')}}" class="avatar-md rounded-circle" alt="User Img">
												</div>
										...
										<div class="dropdown-item notification-item py-2 text-wrap border-bottom" id="notification-3">
											<div class="d-flex">
												<div class="me-2 position-relative flex-shrink-0">
													<img src="{{asset('template/assets/img/profiles/avatar-03.jpg')}}" class="avatar-md rounded-circle" alt="User Img">
												</div>
												<div class="flex-grow-1">
										...
										<div class="dropdown-item notification-item py-2 text-wrap border-bottom" id="notification-5">
											<div class="d-flex">
												<div class="me-2 position-relative flex-shrink-0">
													<img src="{{asset('template/assets/img/profiles/avatar-17.jpg')}}" class="avatar-md rounded-circle" alt="User Img">
												</div>
												<div class="flex-grow-1">
							...
							<div class="dropdown profile-dropdown">
								<a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown"  data-bs-auto-close="outside">
									<span class="avatar online">
										<img src="{{asset('template/assets/img/profiles/avatar-01.jpg')}}" alt="Img" class="img-fluid rounded-circle">
									</span>
								</a>
								<div class="dropdown-menu p-2">
									<div class="d-flex align-items-center bg-light rounded-1 p-2 mb-2">
										<span class="avatar avatar-lg me-2">
											<img src="{{asset('template/assets/img/profiles/avatar-01.jpg')}}" alt="img" class="rounded-circle" >
										</span>
									<div>
