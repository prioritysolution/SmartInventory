...
@section('content')
<body><a href="https://kanakku.dreamstechnologies.com/cdn-cgi/content?id=4_UWs1ZGwC0tPUtN.dAPjI9odUIL3j.EpQ8pM49shtE-1772170305.4202628-1.0.1.1-HAQtf9cwAeuT.lMV9NwtRA9GOFi3IsJELvbvUhXu9ms" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
					...
					<div class="col-md-4 d-flex flex-column">
						<div class="card overflow-hidden z-1 flex-fill">
							...
							<div class="position-absolute end-0 bottom-0 z-n1">
								<img src="{{asset('template/assets/img/bg/card-bg-01.svg')}}" alt="img">
							</div>
						</div> <!-- end card -->
					</div> <!-- end col -->
					<div class="col-md-4 d-flex flex-column">
						<div class="card overflow-hidden z-1 flex-fill">
							...
							<div class="position-absolute end-0 bottom-0 z-n1">
								<img src="{{asset('template/assets/img/bg/card-bg-02.svg')}}" alt="img">
							</div>
						</div> <!-- end card -->
					</div> <!-- end col -->
					<div class="col-md-4 d-flex flex-column">
						<div class="card overflow-hidden z-1 flex-fill">
							...
							<div class="position-absolute end-0 bottom-0 z-n1">
								<img src="{{asset('template/assets/img/bg/card-bg-03.svg')}}" alt="img">
							</div>
						</div> <!-- end card -->
					</div>
				 </div>
										...
										<tbody>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-lg rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-06.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-lg rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-01.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-lg rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-38.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-lg rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-12.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-lg rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-02.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
										...
										<tbody>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-22.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-07.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-16.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-08.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-15.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-27.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-14.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="customer-details.html" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
															<img src="{{asset('template/assets/img/users/user-25.jpg')}}" class="rounded-circle" alt="img">
														</a>
														<div>
						...
						<div class="card flex-fill">
							<div class="card-body pb-1">
								...
								<div class="d-flex align-items-center justify-content-between mb-3">
									<div class="d-flex align-items-center">
										<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
											<img src="{{asset('template/assets/img/icons/transaction-01.svg')}}" class="rounded-circle" alt="img">
										</a>
										<div>
								...
								<div class="d-flex align-items-center justify-content-between mb-3">
									<div class="d-flex align-items-center">
										<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
											<img src="{{asset('template/assets/img/icons/transaction-02.svg')}}" class="rounded-circle" alt="img">
										</a>
										<div>
